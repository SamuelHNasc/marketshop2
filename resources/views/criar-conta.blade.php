<x-layout_base>
            <!-- Card -->
            <div class="p-4 sm:p-7 flex flex-col bg-white rounded-2xl shadow-lg dark:bg-neutral-900 mx-auto m-10 w-2/4">
              <div class="text-center">
                <h1 class="block text-2xl font-bold text-gray-800 dark:text-white">Faça o seu cadastro!</h1>
              ...
              <div class="mt-5">
                    ...
                    <div id="hs-strong-password-popover" class="hidden absolute z-10 w-full bg-gray-100 rounded-lg p-4 dark:bg-neutral-950">
                      ...
                      <ul class="space-y-1 text-sm text-gray-500 dark:text-neutral-500">
                        ...
                        <li data-hs-strong-password-hints-rule-text="lowercase" class="hs-strong-password-active:text-teal-500 flex items-center gap-x-2">
                          ...
                          Precisa ter ao menos uma letra minúscula.
                        </li>
                  ...
                  <div class="col-span-full">
                    ...
                    <div class="relative">
                      ...
                      <label for="hs-hero-signup-form-floating-input-current-password" class="absolute top-0 start-0 p-4 h-full text-sm truncate pointer-events-none transition ease-in-out duration-100 border border-transparent origin-[0_0] dark:text-white peer-disabled:opacity-50 peer-disabled:pointer-events-none
                        ...
                        peer-[:not(:placeholder-shown)]:translate-x-0.5
                        peer-[:not(:placeholder-shown)]:-translate-y-1.5
                        peer-[:not(:placeholder-shown)]:text-gray-500 dark:peer-[:not(:placeholder-shown)]:text-neutral-500 dark:text-neutral-500">Senha atual</label>
                    </div>
                    <!-- End Floating Input -->
                  </div>
                  <!-- End Input Group -->
                ...
                <div class="mt-5 flex items-center">
                  ...
                  <div class="ms-3">
                    <label for="remember-me" class="text-sm dark:text-white">Eu aceito os <a class="text-blue-600 decoration-2 hover:underline font-medium dark:text-blue-500" href="#">Termos e Condições de Uso</a></label>
                  </div>
                </div>
                <!-- End Checkbox -->
    ...
    <!-- Clients Section -->
    <div class="p-10 mt-6 md:mt-12 py-3 flex items-center text-sm text-gray-800 gap-x-1.5 after:flex-1 after:border-t after:border-gray-200 after:ms-6 dark:text-white dark:after:border-neutral-700">
      <span class="font-semibold bg-clip-text bg-gradient-to-l from-blue-600 to-violet-500 text-transparent dark:from-blue-400 dark:to-violet-400">500,000</span>
      individuos confiam no MercadoLivre
    </div>

    <!-- Clients -->
    <div class="p-10 flex flex-wrap gap-x-6 sm:gap-x-12 lg:gap-x-24">
